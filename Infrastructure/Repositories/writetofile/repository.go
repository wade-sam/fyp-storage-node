...
func ReadInJsonFile() (*FileStruct, error) {
	var file FileStruct
	jsonFile, err := os.Open("/Users/sam/Documents/storage-node/Infrastructure/Repositories/writetofile/config.json")
	if err != nil {
...
func WriteJsonFile(file *FileStruct) error {
	...
	err = ioutil.WriteFile("/Users/sam/Documents/storage-node/Infrastructure/Repositories/writetofile/config.json", outputFile, 0775)
	if err != nil {
